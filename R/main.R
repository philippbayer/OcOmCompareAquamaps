...
get_shapes <- function(rds,
  ...
  both <- both |>
    dplyr::mutate(Probability_class = dplyr::case_when(
      Probability > 0.99 ~ "Great (>0.99)",
...
plot_shapes <- function(table, subset = table |>
